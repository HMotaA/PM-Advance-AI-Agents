...
MODEL = os.environ.get("CORTEX_MODEL", "claude-sonnet-5")
...
PRICE_IN = float(os.environ.get("CORTEX_PRICE_IN_PER_M", "2.00"))
PRICE_OUT = float(os.environ.get("CORTEX_PRICE_OUT_PER_M", "10.00"))
...
def run(which: str = "happy") -> None:
    ...
    for step in range(1, MAX_ITERATIONS + 1):
        ...
        # Record the assistant turn verbatim (text + any tool_use blocks) so the
        # conversation history stays valid for the next request.
        ...
        # The assistant turn was already appended above; add only the critic feedback.
